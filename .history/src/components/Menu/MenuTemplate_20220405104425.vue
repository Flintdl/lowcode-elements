                    ...
                    >
                      <div class="sf-input-group">
                        <input
                          ...
                          max="50"
                          v-model="inputBorderRadius"
                          class="sf-text-sm sf-height-fit-content sf-pr-0 sf-pl-1 sf-border-right-0 sf-border-radius-right-0 sf-text-capitalize"
                          placeholder="Curva da Borda"
                        />
                        <div
                          class="sf-input-group-append sf-display-flex sf-justify-content-center"
                        >
                          <div
                            class="sf-display-flex sf-align-items-center sf-border sf-justify-content-center sf-border-left-0 sf-border-radius sf-border-radius-left-0 sf-pr-1 sf-text-info sf-font-weight-bold"
                          >
                            px
                          </div>
                        </div>
