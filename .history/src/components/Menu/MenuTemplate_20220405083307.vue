              ...
              <div class="sf-col-12 sf-form-group">
                ...
                <div class="sf-input-group">
                  ...
                  <div class="sf-input-group-append">
                    <div
                      class="sf-display-flex sf-align-items-center sf-justify-content-center sf-border-left-0 sf-border-radius sf-border-radius-left-0 sf-px-2 sf-color-white"
                    >
                      {{ inputRange }}%
                    </div>
                  </div>
