  ...
  <div>
            ...
            <div class="sf-row">
              ...
              <div class="sf-col-6 sf-form-group">
                ...
                <div class="sf-input-group">
                  ...
                  >
                    <div
                      class="sf-display-flex sf-align-items-center sf-justify-content-center sf-border-left-0 sf-border-radius sf-border-radius-left-0 sf-px-2 sf-text-info sf-font-weight-bold sf-min-60-px"
                    >
                      {{ inputRange }}%
                    </div>
                  </div>
              ...
              <div class="sf-col-auto sf-form-group">
                <input
                  ...
                  checked
                />
                <label for="start"> Esquerda</label>
              </div>
              ...
              <div class="sf-col-auto sf-form-group">
                <input
                  ...
                  value="between"
                />
                <label for="between"> Laterais</label>
              </div>
              <div class="sf-col-auto sf-form-group">
                <input
                  type="radio"
                    ...
                    >
                      <div class="sf-input-group">
                        <input
                          ...
                          max="50"
                          v-model="inputBorderRadius"
                          class="sf-height-fit-content sf-pr-0 sf-pl-1 sf-border-right-0 sf-border-radius-right-0 sf-text-capitalize"
                          placeholder="Curva da Borda"
                        />
                        <div
                          class="sf-input-group-append sf-display-flex sf-justify-content-center"
                        >
                          <div
                            class="sf-display-flex sf-align-items-center sf-border sf-justify-content-center sf-border-left-0 sf-border-radius sf-border-radius-left-0 sf-px-2 sf-text-info sf-font-weight-bold sf-min-60-px"
                          >
                            px
                          </div>
                        </div>
    ...
    <div class="sf-content-page">
      <HomeView
        ...
        :inputBorderRadius="parseInt(inputBorderRadius)"
