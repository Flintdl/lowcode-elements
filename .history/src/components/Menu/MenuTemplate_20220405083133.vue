          ...
          <li class="sf-menu-li sf-px-4">
            <div class="sf-row">
              <div class="sf-col-12 sf-form-group">
                <label class="sf-label sf-text-white">Gap</label>
                <input
                  type="number"
                  min="1"
                  max="12"
              ...
              <div class="sf-col-12 sf-form-group">
                <label class="sf-label sf-text-white">Blocos</label>
                <input
                  type="number"
                  value="1"
                  id="inputQuantidade"
              ...
              <div class="sf-col-12 sf-form-group">
                <label class="sf-label sf-text-white">Bloco por Linhas</label>
                <input
                  type="number"
                  min="1"
                  max="12"
              ...
              <div class="sf-col-12 sf-form-group">
                <label class="sf-label sf-text-white">Tamanho Bloco</label>
                <div class="sf-input-group">
                  <input
                    ...
                    id="inputRange"
                    v-model="inputRange"
                    class="sf-border-right-0 sf-text-capitalize"
                  />
                  <div class="sf-input-group-append">
                    <div
                      class="sf-display-flex sf-align-items-center sf-justify-content-center sf-border sf-border-left-0 sf-border-radius sf-border-radius-left-0"
                    >
                      {{ inputRange }}%
                    </div>
                  </div>
              ...
              <div class="sf-col-12 sf-form-group">
                <label class="sf-label sf-text-white">Altura Bloco</label>
                <input
                  type="range"
                  min="10"
                  max="500"
