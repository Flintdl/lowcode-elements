  ...
  <div>
    ...
    <nav class="sf-menu">
      ...
      <div class="sf-menu-body">
        ...
        <ul class="sf-menu-ul" refs="collapseView" style="display: none">
...
export default {
  ...
  methods: {
    showContent(e) {
      if (this.$refs.collapseView === e.currentTarget.getAttribute("dataRef"))
        console.log(e.currentTarget.getAttribute("dataRef"));
    },
    menu() {
      if (window.innerWidth >= 768) {
