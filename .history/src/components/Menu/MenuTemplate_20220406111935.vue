        ...
        <div class="sf-row sf-px-4" style="visibility: visible">
          ...
          >
            <div
              @click="showContent"
              :dataRef="tab.ref"
              class="sf-bg-hover-info sf-cursor-pointer sf-p-2 sf-text-white sf-font-weight-bold sf-border-radius"
            >
              {{ tab.label }}
            </div>
          </div>
        </div>
        <ul class="sf-menu-ul sf-menu-content open" ref="template-collapse">
