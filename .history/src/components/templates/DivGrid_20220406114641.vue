<template>
  <div
    ...
    ref="container"
  >
    <div class="sf-row sf-height-100">
      <div class="sf-col-12">
        <div
          class="sf-p-2 sf-height-100 sf-display-flex sf-flex-column sf-justify-content-center"
        >
          <i
      ...
      <div class="sf-col-12">
        <div
          class="sf-p-2 sf-height-100 sf-display-flex sf-flex-row sf-justify-content-center sf-align-items-end"
        >
          {{ larguraPixel }}px
          <i
