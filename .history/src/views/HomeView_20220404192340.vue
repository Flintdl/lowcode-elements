<template>
  <div>
    {{ checkValue }}
    <div class="sf-row">
      <div id="sf-preview-code-content" class="sf-col-12 sf-mx-auto">
        <div
          id="sf-preview-code"
          :style="gapProps"
    ...
    <div class="sf-row">
      <div class="sf-col-12">
        <button @click="gerarCodigo">Gerar Código</button>
      </div>
    </div>
    <div class="sf-row">
      <div class="sf-col-12">
        ...
        >
          <code v-if="gerarCodigo != null" id="code-preview">
...
export default {
  ...
  methods: {
    gerarCodigo() {
      return document.getElementById("sf-preview-code").innerHTML;
    },
  },
};
</script>
