    ...
    <div class="sf-row">
      ...
      >
        ...
        <div id="sf-preview-code">
          <div
            :style="gapProps"
            class="sf-display-flex sf-flex-wrap sf-width-100"
          >
            <DivGrid
              v-bind:key="n"
              v-for="n of quantidade"
        ...
        >
          <div
            class="sf-bg-primary sf-position-relative sf-border-radius sf-overflow-hidden sf-position-relative"
            style="width: calc(48% - 4px); height: 193px"
          >
            <span
