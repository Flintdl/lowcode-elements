<template>
  <div>
    <div class="sf-row">
      ...
      <button @click="gerarCodigo">Gerar Codigo</button>
    </div>
    <div class="sf-row" v-if="htmlPreviewCode">
      <div
        class="sf-col-12 sf-mx-auto sf-mt-5 sf-code-content sf-p-4 sf-border-radius sf-bg-code"
      >
        <code style="sf-width-100">
