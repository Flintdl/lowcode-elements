    ...
    <div class="sf-row">
      ...
      >
        <div id="sf-preview-code" ref="previewGrid">
          ...
          >
            <div v-bind:key="n + '_'" v-for="n of feijao" class="sf-row">
              a981231
            </div>
...
export default {
  ...
  computed: {
    cssProps() {
      return {
        flex: `${this.quantidade} 1 0%`,
        "align-self": `${this.checkValue}`,
        "max-width": `calc((${this.valor}% - ${this.inputGap}px * ${
  ...
  mounted() {
    this.feijao = this.quantidade / this.quantidadeLinha;
